...
@Date: 2019-02-11 14:08:52
@LastEditTime: 2019-02-11 16:25:08
@Description: 简体繁体转换
'''
...
class StatesMachine(object):
    ...
    def feed(self, char, map):
        ...
        if cond == ERROR:
            ...
            raise StatesMachineException(f'Translate States Machine have error with input {node}')
        return new
